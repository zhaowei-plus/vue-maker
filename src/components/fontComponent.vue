<template>
    <div class="operation-warpper"
         :style='{left: element.left, top: element.top, width: element.width/2+"px", height: element.height/2+"px", zIndex: element.zindex}'>
        <input type="text" :value="element.text">

        <div class="opertion left top" ref="move" v-icon-drag>
